...
-   [github.com/rreece/covariance_calculators](https://github.com/rreece/covariance_calculators)
...
[^Bishop2024p76]: @Bishop_2024_Deep_Learning_Foundations_and_Concepts\, p. 76--81.
    ...
    See also @Styan_1983_Schur_complements_and_linear_statistical_models\.
...
![Tuning the lasso regularization parameter.
    ](img/n-edges-g-lasso.png){#fig-n-edges-g-lasso}
...
-   Deng, W., Polak, P., Safikhani, A., & Shah, R. (2024). A unified framework for fast large-scale portfolio optimization. [^Deng2024]

[^Deng2024]: @Deng_2024_A_unified_framework_for_fast_large_scale_portfolio\.


Geometry of covariance
--------------------------------------------

-   Rousseeuw, P.J. & Molenberghs, G. (1994). The shape of correlation matrices. [^Rousseeuw1994]

[^Rousseeuw1994]: @Rousseeuw_1994_The_shape_of_correlation_matrices\.
