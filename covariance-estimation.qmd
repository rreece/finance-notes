...
Precision and partial correlation
--------------------------------------------
...
is the inverse of a precision matrix of a partition.

Schur complement lemma (TODO: prove or motivate):
...
Let us partition our observable variables into two sets:

$$ A = \{ x_{i}, x_{j} \} \qquad B = \{ \mathrm{rest} \} $$

That is equivalent to the covariance of the residuals when fitting the rest of the variables (TODO: motivate).
...
TODO: Expand on why are precision matrices sparse.
See discussion in Chan & Kroese. [^Chan2025]

Combining our results shows that $\Omega$ can be factored as
...
(and $P_{ii} = 1$),
we can define the partial correlation matrix as
...
-   Banerjee, O., d'Aspremont, A., & Ghaoui, L.E. (2005). [Sparse covariance selection via robust maximum likelihood estimation](https://arxiv.org/abs/cs/0506023).
-   Friedman, J., Hastie, T. and Tibshirani, R. (2008). [Sparse inverse covariance estimation with the graphical lasso](https://www.asc.ohio-state.edu/statistics/statgen/joul_aut2015/2008-Friedman-Hastie-Tibshirani.pdf).
-   Mazumder, R. & Hastie, T. (2011). [The graphical lasso: New insights and alternatives](https://arxiv.org/abs/1111.5479).
-   Chang, B. (2015). [An introduction to graphical lasso](https://bochang.me/gmrg/files/Bo_05152015.pdf).
-   Maxime, A. (2015). [Inverse covariance matrix regularization for minimum variance portfolio](https://www.geneve-finance.ch/file.cfm?contentid=950).
-   Erickson, S. & Ryd&eacute;n, T. (2025). [Inverse covariance and partial correlation matrix estimation via joint partial regression](https://arxiv.org/abs/2502.08414).
