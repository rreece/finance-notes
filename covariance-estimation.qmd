...
[^Bishop2024p76]: @Bishop_2024_Deep_Learning_Foundations_and_Concepts\, p. 76--81.
    TODO: Need to clarify which detail rely on the data being Gaussian.
    Claude warns:      
...
-   Erickson, S. & Ryd&eacute;n, T. (2025). [Inverse covariance and partial correlation matrix estimation via joint partial regression](https://arxiv.org/abs/2502.08414). [^Erickson2025]
...
[^Erickson2025]: @Erickson_2025_Inverse_covariance_and_partial_correlation_matrix\.
