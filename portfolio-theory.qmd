...
-   Raffinot, T. (2018). Hierarchical clustering-based asset allocation. [^Raffinot2018a]
-   Raffinot, T. (2018). The hierarchical equal risk contribution portfolio. [^Raffinot2018b]
...
$$ \tilde{d}_{ij} = \sqrt{ \sum_{n}^{n} \left( d_{ni} - d_{nj} \right)^{2} } \label{eq:hrp_tilde_distance} $$
