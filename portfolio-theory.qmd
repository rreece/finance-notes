...
But also note that the $\vec{\delta} \: \vec{\delta^\prime}^\intercal$ is also convenient
because it comes naturally normalized can be readily generalized for weighting.
