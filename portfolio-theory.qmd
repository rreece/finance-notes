...
$$ \hat{\beta}_{ij}^\intercal = \sum_k \big[ \mathrm{cov}(\vec{f}, \vec{f})^{-1} \big]_{jk} \, \big[ \mathrm{cov}(\vec{f}, \vec{r}) \big]_{ki} $$

or

$$ \big[ \hat{\beta}^{\intercal} \big]_{ji} = \sum_k \big[ \mathrm{Cov}(f, f)^{-1} \big]_{jk} \, \big[ \mathrm{Cov}(f, r) \big]_{ki} $$
