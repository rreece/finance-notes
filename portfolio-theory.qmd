...
$$ r_{it} - r_{ft} = a_{i} + b_{i} \, (r_{mt} - r_{ft}) + s_{i} \, \mathrm{SMB}_{t} + h_{i} \, \mathrm{HML}_{t} + \varepsilon_{it} $$

Five-factor model:

$$ r_{it} - r_{ft} = a_{i} + b_{i} \, (r_{mt} - r_{ft}) + s_{i} \, \mathrm{SMB}_{t} + h_{i} \, \mathrm{HML}_{t} + r_{i} \, \mathrm{RMW}_{t} + c_{i} \, \mathrm{CMA}_{t} + \varepsilon_{it} $$
...
$$ r_{it} - r_{ft} = a_{i} + b_{i} \, (r_{mt} - r_{ft}) + s_{i} \, \mathrm{SMB}_{t} + h_{i} \, \mathrm{HML}_{t} + u_{i} \, \mathrm{UMD}_{t} + \varepsilon_{it} $$
...
-   Asness, C. & Frazzini, A. (2013). The Devil in HML's Details. *Journal of Portfolio Management*, 39, 49--68. https://doi.org/10.3905/jpm.2013.39.4.049 
...
$$ r_{it} - r_{ft} = a_{i} + b_{i} \, (r_{mt} - r_{ft}) + s_{i} \, \mathrm{SMB}_{t} + h_{i} \, \mathrm{HML}_{t} + r_{i} \, \mathrm{RMW}_{t} + c_{i} \, \mathrm{CMA}_{t} + u_{i} \, \mathrm{UMD} + \varepsilon_{it} $$
