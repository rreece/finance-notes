...
![The efficient frontier and no-shorts frontier for a few example assets,
    using historical daily data from 2014-01-02 to 2024-08-30, 10 years and 9 months.
...
Tobin[^Tobin1958] is often credited as the first to note and
Merton[^Merton1972b] exposited formally the *One-fund theorem*:
...
$$ \vec{w} = \kappa \, \vec{w}_{f} + (1-\kappa) \, \vec{w}_{t} $$

The portfolio return is

$$ r = \kappa \, r_{f} + (1-\kappa) \, r_{t} $$

The portfolio standard deviation is

$$ \sigma = \left| 1-\kappa \right| \sigma_{t} $$
...
and follows the line further up for one allows borrowing at the risk-free rate
...
$$ r_\mathrm{CAL}(\sigma) = r_{f} + \sigma \, \sqrt{c - 2 \, b \, r_{f} + a \, r_{f}^{2}} $$
...
Efficient frontier without borrowing:

$$ \sigma_{\ast}(r_{\ast}; r_{f}) = X $$

TODO:

-   Citation need for the one-fund theorem
-   CAL intersection at the tangent portfolio
-   Case-wise functional form of the efficient frontier without borrowing
